import {SERVICE_NAME, URL_DOMAIN, VERIFY_EMAIL_DOMAIN} from "@/config/config";


export default function getVerificationEmail(user: any, token: string): string {
...
<div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">Verify your new ${SERVICE_NAME} account</div>
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                            ...
                            <tr style="width:100%"><img src="https://cdn.rgxdev.de/api/files/download/images/lock.png" style="display:block;outline:none;border:none;text-decoration:none;max-width:100%" width="620" /></tr>
                            </tbody>
                        </table>
                        <table align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding:20px;padding-bottom:0" width="100%">
                            ...
                            <tr style="width:100%">
                                <td data-id="__react-email-column">
                                    ...
                                    <p style="font-size:16px;line-height:24px;margin:16px 0">Thank you for signing up with ${SERVICE_NAME}! Please verify your email address to start using all our features.</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
